...
//    int uberflu? = 1; // //Невозможно создать данную переменную - компилятор ругается
    ...
    int \u006fIdentifier = 3; //Создать переменную возможно и даже можно вывести её значение, но программа ругается на такое название. Судя по всему лучше такое не использовать.
